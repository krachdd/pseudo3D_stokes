...
# runs 
python3 runStokesGeneric.py -dir test_periodic_BC -input genericInputPeriodic.input -vs 1e-6 -height 36.0e-6 -dumux $DUMUXPATH -exec $EXECUTABLE -get_phi -vtu -govEq brinkman -no_lambda 
